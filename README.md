...
| Tab | What it shows |
|---|---|
| **Conferences** | Major AI/ML conference calendar through 2028 — NeurIPS, ICML, ICLR, CVPR, ICCV, ECCV, ACL, EMNLP, AAAI, IJCAI, KDD, COLM, WACV — with dates, locations, prestige-tier indicators (Big Three / Field flagship / Top tier / Emerging / Applications), and an expandable **Key dates** panel per conference (abstract/paper deadlines, notification, camera-ready, workshop and session days) |
